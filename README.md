This fork has the (extremely minor) changes to cboot (description below) necessary so that is compatible with at least sage-8.4. N.B the change that must be made to module_list.py compared to the original.
